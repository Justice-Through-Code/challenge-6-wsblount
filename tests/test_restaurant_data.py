...
class TestRestaurantData(TestCase):
    ...
    def test_explore_data(self, mock_stdout):
        ...
        expected += "375 Valencia St, San Francisco, CA, 94103\n"

        self.assertEqual(expected, mock_stdout.getvalue())

    @mock.patch('builtins.input', side_effect=['Islands', '10948 W Pico Blvd', 'Tortilla Soup'])
    @mock.patch('sys.stdout', new_callable=io.StringIO)
    def test_favorite_restaurant(self, mock_stdout, mock_input):
        favorite_restaurant()

        expected = "{'name': 'Islands', 'address': '10948 W Pico Blvd', 'favorite_dish': 'Tortilla Soup'}\n"
        expected += "{'name': 'Islands', 'address': '10948 W Pico Blvd'}\n"
